...
Reference: https://en.wikipedia.org/wiki/Bellman–Ford_algorithm
"""
...
class BellmanFord(object):
    ...
    def __init__(self, data):
        """
        Creates a new instance of the Bellman Ford algorithm on data
        passed in through the object constructor.
        """
    ...
    def shortest_paths(self, start_vertex, tolerance=0):
        """
        Finds the shortest paths (sum of edge weights) from start_vertex
