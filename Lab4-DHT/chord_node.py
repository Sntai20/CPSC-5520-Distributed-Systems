...
class ModRange(object):
    ...
    def __init__(self, start, stop, divisor):
        ...
        # we want to use ranges to make things speedy, 
        # but if it wraps around the 0 node, we have to use two.
...
class FingerEntry(object):
    ...
    def __init__(self, n, k, node=None):
        """
        The FingerEntry default constructor.
        """
...
class ChordNode():
    ...
    def call_rpc(self, id, placeholder):
        """
        This method determines which RPC to call, then calls the rpc.
        To determine which RPC to call this method uses the placeholder.
        param: id
        param: placeholder
        """
        return self.rpc(id, placeholder)

    def rpc(self, id, placeholder):
        """
        This is a template for the RPCs we plan to use.
        """
        print(f"RPC method {id} {placeholder}.")
