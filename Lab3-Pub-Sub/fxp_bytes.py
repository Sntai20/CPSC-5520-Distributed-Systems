...
def serialize_price(x: float) -> bytes:
    ...
    little-endian ieee754 machine b'\\x05\\x04\\x03\\x02\\x01\\xff?C'
...
def marshal_message(quote_sequence) -> bytes:
    ...
    >>> b = marshal_message([{'timestamp': datetime(2006,1,2),
    'cross': 'GBP/USD', 'price': 1.22041}, \{'timestamp': datetime(2006,1,1),
    'cross': 'USD/JPY', 'price': 108.2755}])
    ...
    b'\\x00\\x04\\t@\\xbf]\\xe0\\x00USDJPY\\x12\\x83\\xc0\\xca\\xa1\\x11[@\\x00\\x00\\x00
